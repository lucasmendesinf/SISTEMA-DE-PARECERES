...
<head>
  ...
  <link rel="manifest" href="manifest.json?v=20260826-logo-quota-1">
  ...
  <link rel="stylesheet" href="pwa-admin.css?v=20260826-logo-quota-1">
...
<body data-role="<?= $escape($bootstrapUser['role']) ?>">
  ...
  <script src="text-ai-review.js?v=20260826-logo-quota-1"></script>
  <script src="document-button-fix.js?v=20260717-require-student-1"></script>
  <script src="director-email.js?v=20260826-logo-quota-1"></script>
  ...
  <script src="onboarding.js?v=20260826-logo-quota-1"></script>
  ...
  <script src="ai-usage-admin.js?v=20260826-logo-quota-1"></script>
  <script src="pwa-admin.js?v=20260826-logo-quota-1"></script>
  ...
  <script src="pwa.js?v=20260826-logo-quota-1"></script>
</body>
</html>
