...
<head>
  ...
  <link rel="manifest" href="manifest.json?v=20260804-activity-save-list-1">
...
<body data-role="<?= $escape($bootstrapUser['role']) ?>">
  ...
  <script src="app.js?v=20260804-activity-save-list-1"></script>
  ...
  <script src="activities-edit.js?v=20260804-activity-save-list-1"></script>
  ...
  <script src="report-editor.js?v=20260716-activity-selection-lock-1"></script>
