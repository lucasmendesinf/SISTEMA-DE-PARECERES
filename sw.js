const CACHE_VERSION = 'ai-prof-pwa-20260804-activity-photo-compress-1';
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const STATIC_ASSETS = [
  './offline.html',
  './manifest.json?v=20260804-activity-photo-compress-1',
  ...
  './document-style.css?v=20260716-activity-selection-lock-1',
