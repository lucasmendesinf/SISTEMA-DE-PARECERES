const CACHE_VERSION = 'ai-prof-pwa-20260706-video-before-onboarding-2';
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const STATIC_ASSETS = [
  './offline.html',
  './login.css?v=20260702-billing-modal-1',
  './style.css?v=20260706-floating-help-2',
  './mobile-menu.css?v=20260705-mobile-scroll-1',
  './activity-pagination.css',
  './report-type-badge.css',
  './experience-fields.css',
  './brand-logo.css',
  './user-profile.css?v=20260706-profile-menu-1',
  ...
  './image-editors.css?v=20260706-crop-hidden-canvas-1',
  ...
  './onboarding.js?v=20260706-video-before-onboarding-2',
  './report-editor.js?v=20260706-final-people-label-1',
  './document-style-settings.js?v=20260706-document-style-save-1',
