const CACHE_VERSION = 'ai-prof-pwa-20260716-deliver-drive-timeout-1';
...
const STATIC_ASSETS = [
  ...
  './brand-logo.css',
  './user-profile.css?v=20260716-gemini-review-1',
  ...
  './google-drive-integration.js?v=20260716-deliver-drive-timeout-1',
