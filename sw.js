const CACHE_VERSION = 'ai-prof-pwa-20260826-pwa-chrome-native-1';
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const STATIC_ASSETS = [
  './offline.html',
  './manifest.json?v=20260826-pwa-chrome-native-1',
  './pwa.js?v=20260826-pwa-chrome-native-1',
  './login.css?v=20260826-pwa-chrome-native-1',
  ...
  './google-drive-integration.css?v=20260717-drive-document-type-1',
  ...
  './onboarding.css?v=20260826-onboarding-mobile-layout-1',
  './save-feedback.css?v=20260717-save-feedback-front-1',
  './pwa-admin.css?v=20260826-pwa-chrome-native-1',
  './pwa-install.css?v=20260826-pwa-chrome-native-1',
  './save-feedback.js?v=20260717-save-feedback-front-1',
  './onboarding.js?v=20260826-pwa-chrome-native-1',
  ...
  './text-ai-review.js?v=20260826-pwa-chrome-native-1',
  './document-button-fix.js?v=20260717-require-student-1',
  './director-email.js?v=20260826-pwa-chrome-native-1',
  ...
  './ai-usage-admin.js?v=20260826-pwa-chrome-native-1',
  './pwa-admin.js?v=20260826-pwa-chrome-native-1',
  './pwa-install.js?v=20260826-pwa-chrome-native-1',
